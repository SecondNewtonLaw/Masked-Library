...
public static class StringExt {
    ...
    public static async Task<string> SanitizeString(this string fileName, char[] illegalCharacters,
        CancellationToken tken = new()) {
        var stringChars = fileName.ToCharArray();
    ...
    public static Task<bool> Contains(this string[] strArr, string target,
    ...
    public static Task<bool> IsBase64(this string str) {
        return Task.Run(() => Convert.TryFromBase64String(str, new Span<byte>(), out _));
    }
}